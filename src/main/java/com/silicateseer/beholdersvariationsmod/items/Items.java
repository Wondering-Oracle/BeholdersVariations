...
public class Items 
{
	...
	public static final RegistryObject<Item> SILICASTONE_SLAB = ITEMS.register("silicastone_slab", 
			() -> new BlockItem(Blocks.SILICASTONE_SLAB.get(), 
